...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var exec, _a, stdout, stderr, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, fs_extra_1.remove)('./dist/')];
            case 2:
                // Remove current build
                _b.sent();
            ...
            case 3:
                ...
                if (!!stderr)
                    jet_logger_1.default.err(stderr);
                jet_logger_1.default.info("Project built successfully");
                return [3 /*break*/, 5];
            case 4:
                err_1 = _b.sent();
